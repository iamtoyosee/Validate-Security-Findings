...
| 1 | Reachability MVP: Python call graph, entry-point detection, backward traversal, path evidence | Design settled — building it ourselves (atom trialed hands-on, produced a real false positive + real false negatives; full reasoning documented), not yet built | [docs/phase-1-foundations.md](docs/phase-1-foundations.md) |
